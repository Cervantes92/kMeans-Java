...
public class kMethods {
	...
	public static double[][] kMeans(double[][] clusterField, int numberOfClusters, double stability) {
		...
		//Declare loop indexes to work around nested loop index declaration issue because I like being consistent with my indexes.
		int i;
		int j;
		...
		//TODO: Check null in algorithm's main loop.
